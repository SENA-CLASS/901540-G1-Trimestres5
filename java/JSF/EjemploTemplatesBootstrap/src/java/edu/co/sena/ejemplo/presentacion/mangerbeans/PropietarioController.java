package edu.co.sena.ejemplo.presentacion.mangerbeans;

import edu.co.sena.ejemplo.integracion.entities.Propietario;
import edu.co.sena.ejemplo.presentacion.mangerbeans.util.JsfUtil;
import edu.co.sena.ejemplo.presentacion.mangerbeans.util.JsfUtil.PersistAction;
import edu.co.sena.ejemplo.negocio.ejbs.PropietarioFacade;
...
public class PropietarioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemplo.negocio.ejbs.PropietarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setPropietarioPK(new edu.co.sena.ejemplo.integracion.entities.PropietarioPK());
    }
    ...
    public Propietario getPropietario(edu.co.sena.ejemplo.integracion.entities.PropietarioPK id) {
    ...
    public static class PropietarioControllerConverter implements Converter {
        ...
        edu.co.sena.ejemplo.integracion.entities.PropietarioPK getKey(String value) {
            edu.co.sena.ejemplo.integracion.entities.PropietarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.ejemplo.integracion.entities.PropietarioPK();
        ...
        String getStringKey(edu.co.sena.ejemplo.integracion.entities.PropietarioPK value) {
