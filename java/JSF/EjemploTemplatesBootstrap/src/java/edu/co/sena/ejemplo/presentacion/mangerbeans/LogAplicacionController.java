...
import edu.co.sena.ejemplo.negocio.ejbs.LogAplicacionFacade;
...
public class LogAplicacionController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemplo.negocio.ejbs.LogAplicacionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("LogAplicacionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("LogAplicacionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("LogAplicacionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
