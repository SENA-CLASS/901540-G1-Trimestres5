...
import edu.co.sena.ejemplo.negocio.ejbs.CuentaFacade;
...
public class CuentaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemplo.negocio.ejbs.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new edu.co.sena.ejemplo.integracion.entities.CuentaPK());
    }
    ...
    public Cuenta getCuenta(edu.co.sena.ejemplo.integracion.entities.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        edu.co.sena.ejemplo.integracion.entities.CuentaPK getKey(String value) {
            edu.co.sena.ejemplo.integracion.entities.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.ejemplo.integracion.entities.CuentaPK();
            key.setTipoDocumentotipodocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.ejemplo.integracion.entities.CuentaPK value) {
