 ...
 * @author hernando
 */
@WebFilter(filterName = "NewFilter1", urlPatterns = {"/admin/*"}
    )
            ...
            //try {
             ...
             if(session!=null){
                ...
                if (session.getAttribute("usuario") == null) {
                    ...
                    wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/logueo.html");
                    ...
                    wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/cliente/cliente.html");
                    }
                }
             }else{
             wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/logueo.html");
