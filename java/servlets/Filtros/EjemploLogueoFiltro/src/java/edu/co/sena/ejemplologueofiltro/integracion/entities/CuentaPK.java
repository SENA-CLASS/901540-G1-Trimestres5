...
public class CuentaPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemplologueofiltro.integracion.entities.CuentaPK[ tipoDocumentotipodocumento=" + tipoDocumentotipodocumento + ", numeroDocumento=" + numeroDocumento + " ]";
    }
