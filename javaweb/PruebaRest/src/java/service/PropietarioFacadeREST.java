...
import entidades.PropietarioPK;
...
public class PropietarioFacadeREST extends AbstractFacade<Propietario> {
    ...
    private PropietarioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        entidades.PropietarioPK key = new entidades.PropietarioPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entidades.PropietarioPK key = getPrimaryKey(id);
