 ...
 */
package edu.co.sena.ceetregistro.integracion.entitites.log;
...
public class LogAplicacion implements Serializable {
    ...
    public LogAplicacion(String nivel, String mensaje, String log, Date hora) {
        this.nivel = nivel;
    ...
    public String toString() {
        return "edu.co.sena.ceetregistro.integracion.entitites.log.LogAplicacion[ idlogAplicacion=" + idlogAplicacion + " ]";
    }
